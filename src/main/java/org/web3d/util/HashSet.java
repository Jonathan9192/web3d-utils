...
public class HashSet<E> {
    ...
    private static class Entry<E>
    {
         ...
         */
        protected Entry(int hash, E value, Entry<E> next)
        {
            this.hash = hash;
            this.value = value;
            this.next = next;
    ...
    public HashSet(int initialCapacity, float loadFactor) {
        ...
        // Currently, no ability to create a typed array Entry<E>[]
    ...
    public Object get(Object o) {
        /** This code was copied directly from 'contains' and modified to return the
         *  located value.
         */
        if(o == null)
            return null;
     ...
     * @throws NullPointerException if the specified collection is null
     */
    public boolean addAll(HashSet<E> hs) {
        boolean modified = false;

        for(Entry<E> e : hs.table)
        {
            while ( e != null)
            {
                if (add(e.value))
     ...
     * @throws NullPointerException if the specified collection is null.
     */
    public boolean removeAll(HashSet<E> hs) {
        boolean modified = false;
     ...
     * end of the collection.  We produce a known unchecked cast to the specified
     * array type, therefore we suppress the warning during compile time.
     *
     * @param array the array into which the elements of the set are to
     *     be stored, if it is big enough; otherwise, a new array of the
     *     same runtime type is allocated for this purpose.
     * @return an array containing the elements of the collection type.
