...
*/
    ...
    public final Vec3DDouble interpolateTo(ReadonlyVec3DDouble v, double f,
        ...
        return new Vec3DDouble((double)s.interpolate((float)x, (float)v.x(), (float)f),
                (double)s.interpolate((float)y, (float)v.y(), (float)f), (double)s.interpolate((float)z, (float)v.z(), (float)f));
    }
    ...
    public final Vec3DDouble interpolateTo(Vec3DDouble v, double f, InterpolateStrategy s) {
        return new Vec3DDouble((double)s.interpolate((float)x, (float)v.x, (float)f), (double)s.interpolate((float)y, (float)v.y, (float)f),
                (double)s.interpolate((float)z, (float)v.z, (float)f));
    }
    ...
    public final Vec3DDouble interpolateToSelf(ReadonlyVec3DDouble v, double f,
            InterpolateStrategy s) {
        x = (double) s.interpolate((float)x, (float)v.x(), (float)f);
        y = (double) s.interpolate((float)y, (float)v.y(), (float)f);
        z = (double) s.interpolate((float)z, (float)v.z(), (float)f);
        return this;
    }
